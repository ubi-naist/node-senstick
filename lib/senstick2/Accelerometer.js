...
// 加速度センササービス
const SENSTICK2_ACCELEROMETER_SENSOR_SERVICE_UUID       = 'f000210004514000b000000000000000';
const SENSTICK2_ACCELEROMETER_MEASUREMENT_CONFIG_CHAR   = 'f000710004514000b000000000000000';
const SENSTICK2_ACCELEROMETER_REALTIME_DATA_CHAR        = 'f000720004514000b000000000000000';
const SENSTICK2_ACCELEROMETER_TARGET_LOGID_CHAR         = 'f000730004514000b000000000000000';
const SENSTICK2_ACCELEROMETER_LOGMETADATA_CHAR          = 'f000740004514000b000000000000000';
const SENSTICK2_ACCELEROMETER_LOGDATA_CHAR              = 'f000750004514000b000000000000000';
 ...
 * @param {AccelerometerMeasurementRange|undefined} measurement_range   - 加速度センサの測定レンジ．
 */
 ...
 * @param {AccelerometerMeasurementRange}   measurement_range   - 加速度センサの測定レンジ．
 ...
 * @param {callback}                        callback                - コールバック関数．
 */
SenStick2AccelerometerSensorService.prototype.writeAccelerometerMeasurementRange = function(measurement_range, callback)
{
 ...
 */
SenStick2AccelerometerSensorService.prototype.readAccelerometerLogMetaData = function(callback)
{
 ...
 * @param {AccelerometerMeasurementRange|undefined} measurement_range   - このログの測定レンジ．
 ...
 * @param {AccelerometerMeasurementRange}   range   - 測定レンジの値．
