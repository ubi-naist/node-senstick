 ...
 * @param {number}          datetime[].year     - 年．0はunknownを示す．
 * @param {number}          datetime[].month    - 月(0から12)．0はunknownを示す．
 * @param {number}          datetime[].day      - 日(0から<I>month</I>の日数)．0はunknownを示す．
 * @param {number}          datetime[].hour     - 時(0から23)
 * @param {number}          datetime[].minute   - 分(0から59)
 * @param {number}          datetime[].second   - 秒(0から59)
 */
